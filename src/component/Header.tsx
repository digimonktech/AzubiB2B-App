            ...
            return (
                <>
                    <View style={{ flexDirection: 'row' }}>
                        <TouchableOpacity style={styles.leftComponentIsBack} onPress={() => backPressImg()}>
            ...
            return (
                <>
                    <TouchableOpacity style={styles.leftComponentLogo}>
                        <Image source={Images.logoMain} style={styles.menubarLogo} resizeMode='contain'/>
                    </TouchableOpacity>
                    <Image source={Images.dividerLine} style={styles.lineDivider} />
                </>
            );
            ...
            return (
                <TouchableOpacity onPress={() => navigation.navigate(NOTIFICATION)}>
                    <View style={styles.rightComponent}>
                        <Image source={Images.notification} style={{ height: 80, width: 80, marginTop: 15 }} />
                    </View>
                </TouchableOpacity>
            );
        }
